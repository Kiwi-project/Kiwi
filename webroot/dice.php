...
// Do it and store it all in variables in the Kiwi container.
$kiwi['title'] = "Kasta tärning";

$kiwi['main'] = <<<EOD
<h1>Kasta tärning</h1>
<p>Detta är en exempelsida som visar hur Kiwi fungerar tillsammans med återanvändbara moduler.</p>
